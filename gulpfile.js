...
import { copy, copy_php, copy_js, copy_fonts } from "./gulp/tasks/copy.js";
...
function watcher() {
  ...
  gulp.watch(path.watch.php, copy_php)
}


// Методы объеденены в одне переменную, которые выполняются параллельно
const mainTasks = gulp.parallel(copy_fonts, copy, copy_php, copy_js, html, scss, images);
